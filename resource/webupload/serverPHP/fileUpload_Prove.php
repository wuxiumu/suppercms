...
class fileUpload_Prove{
    ...
    function path($type){
        ...
        {
            case "touxiang"://头像
                $uploadpath=$path."/touxiang";
                break;
            case "spacebankgroud"://空间背景
                $uploadpath=$path."/spacebankgroud";
                break;
            case "idenimage"://资格认证
                $uploadpath=$path."/idenimage";
                break;
            case "filnkimage"://合作伙伴
                $uploadpath=$path."/filnkimage";
                break;
            case "bannerimg"://合作伙伴
                $uploadpath=$path."/bannerimg";
                break;
            case "vip_image"://vip_image
                $uploadpath=$path."/vip_image";
                break;
            case "advert"://vip_image
                 $uploadpath=$path."/advert";
                 break;
            case "vip_advert"://vip_advert
                $uploadpath=$path."/vip_advert";
                break;
            default:
                $uploadpath=$path."/public";
        }
        ...
        $year=date("Ym",time());
        $up_file=$uploadpath."/".$year;
        if (!file_exists($up_file) || !is_writable($up_file)){
            mkdir($up_file,"0777");
        }
        $day=date("d",time());
        $this->path=$up_file."/".$day;
        return  $this->path;
    }
...
$uploader = new fileUpload_Prove();
$uploader->path($_POST['imagetype']);
...
$year=date("Ym",time());
$day=date("d",time());
switch ($_POST["imagetype"])//上传路径
{
    case "touxiang"://头像
        $uploadpath="/public/file/touxiang/".$year."/".$day."/";
        break;
    case "spacebankgroud"://空间背景
        $uploadpath="/public/file/spacebankgroud/".$year."/".$day."/";
        break;
    case "idenimage"://资格认证
        $uploadpath="/public/file/idenimage/".$year."/".$day."/";
        break;
    case "filnkimage"://合作伙伴
        $uploadpath="/public/file/filnkimage/".$year."/".$day."/";
        break;
    case "bannerimg"://banner列表
        $uploadpath="/public/file/bannerimg/".$year."/".$day."/";
        break;
    case "vip_image"://vip_image
        $uploadpath="/public/file/vip_image/".$year."/".$day."/";
        break;
    case "advert"://vip_image
        $uploadpath="/public/file/advert/".$year."/".$day."/";
        break;
    case "vip_advert"://vip_image
         $uploadpath="/public/file/vip_advert/".$year."/".$day."/";
         break;
    default:
        $uploadpath="/public/file/public/".$year."/".$day."/";
}
