 ...
 *  支持单文件和多文件上传
 */
class fileUpload_chat_file{
    //要配置的内容
    private $path = "";
    private $allowtype = array('dwg', 'zip', 'rar', 'doc', 'docx', 'xlsx', 'xls', 'ppt','pptx','jpg', 'gif', 'png');
...
$uploader = new fileUpload_chat_file();
...
{
    case "file"://文件
        $uploadpath="/chatlog_file/file/".$year."/".$day."/";
        break;
    case "img"://图片
        $uploadpath="/chatlog_file/img/".$year."/".$day."/";
        break;
    default:
